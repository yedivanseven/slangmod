...
the location of your raw :doc:`data files <data>`. You might have seen this
command-line option when you tried out the CLI for the first time during
basic :doc:`configuration`:
